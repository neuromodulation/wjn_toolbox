function wjn_eeg_vm_source_localisation(filename,baseline)

sk=[12 12 12];
timeranges = [-1000 0; 0 1000;-1000 1000];
freqranges = [2 7;7 13;13 20;20 35;13 35;40 80];
D=spm_eeg_load(filename);
wjn_eeg_source_power(D.fullfile,freqranges,baseline,'go','baseline','dics')
wjn_eeg_source_power(D.fullfile,freqranges,timeranges,'move','move','dics')
