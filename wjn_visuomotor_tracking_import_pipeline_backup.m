...
names ={'Ntrial','Block','Block13as1','Condition','SwitchTrials','Outlier','ReactionTime','MovementTime','PerformanceTime','MaximumVelocity','TrajectoryError','AngularError','Accuracy','MovementVariance','ErrorTrial'};
vars = {'a','rblock','block','cond','swt','ot','rt','mv','pt','v','merror','ang','acc','sbi','err'};
...
vars = {'a','rblock','cond','swt','ot','rt','mv','pt','v','merror','ang','acc','sbi','err'};
