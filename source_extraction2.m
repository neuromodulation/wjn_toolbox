function source_extraction2(folder,file,condition,emgchans,lfpchans,position,freqrange,target_name,source_name,radius,side)
...
imfolder = fullfile(folder,subfolder,'images')
mkdir(subfolder);
mkdir(imfolder)
