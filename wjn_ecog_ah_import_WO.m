...
cd(fullfile(mdf,'ecog'))
filename = 'WO05_LT.mat';
...
xlim([5 40])
figone(7,30)
myprint('Burst power comparison 1')
...
myprint('Burst power correlations 1')
...
cmspac = squeeze(nanmean(Dp(4:Dp.nchannels,:,:,1),1));
cmlpac = squeeze(nanmean(Dp(4:Dp.nchannels,:,:,2),1));
