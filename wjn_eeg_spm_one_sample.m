function wjn_eeg_spm_one_sample(folder,files)
spm('defaults','EEG')
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'greater_0';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'smaller_0';
