function  D=wjn_eeg_eloreta_mesh_extraction(filename,downsample_mesh,addchannels)
...
matlabbatch{4}.spm.tools.beamforming.inverse.plugin.eloreta.regularisation = 0.05;
...
matlabbatch{6}.spm.tools.beamforming.write.plugin.spmeeg.prefix = 'L';
spm_jobman('run',matlabbatch)
D=wjn_sl(fullfile(fdir,['L' fname]));
