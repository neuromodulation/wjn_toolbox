...
switch initials
    case 'PLFP41'
        ...
        hdr = ft_read_header([ dir '/' initials '/' lower(initials) block '.con']); % plfp41.0100.con
        ...
        indl = [17 18 19 20 21 22 23 24];
        % input socket for right side       
		indr = [16+9 16+10 16+11 16+12 16+13 23-16 24-16 17-16];
 ...
 case 'PLFP42'
        ...
        hdr = ft_read_header([ dir '/' initials '/' lower(initials) block '.con']); % plfp42.0100.con
        ...
        indl = [17 18 19 20 21 22 23 24];
        % input socket for right side
		indr = [16+9 16+10 16+11 16+12 22-16 23-16 24-16 17-16]; 
    ...
    case 'PLFP43'
        ...
        hdr = ft_read_header([ dir '/' initials '/' lower(initials) block '.con']); % plfp43.0200.con / plfp43.0400.con
        ...
        indl = [17 18 19 20 21 22 23 24];
        % input socket for right side
		indr = [16+9 16+10 16+11 16+12 17-16 22-16 23-16 24-16]; 
    ...
    case 'PLFP44'  
        ...
        hdr = ft_read_header([ dir '/' initials '/' lower(initials) block '.con']); % plfp44.0100.con
