function wjn_normalize_nii(nii)
% - Lead-DBS Job created on 29-Mar-2017:
% --------------------------------------
...
addpath(genpath('C:\Users\User\Dropbox\matlab\leaddbs'));
addpath('C:\Users\User\Dropbox\matlab\spm12');
...
options.atlasset = 'STN-Subdivisions (Accolla 2014)';
options.atlassetn = 24;
...
%%
options.dolc = 0;
options.uipatdirs = {'C:\Users\User\Dropbox\Motorneuroscience\visuomotor_tracking_ana\lead\1_LEHMANN_BOSTON_16'};
...
options.prefs.lc.datadir = 'C:\Users\User\Dropbox\matlab\leaddbs\connectomes\';
...
options.prefs.mer.defaulttract = 2;
