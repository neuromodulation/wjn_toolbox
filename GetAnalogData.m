function [time, AnalogWaveforms, AnalogElectrodeIDs] = GetAnalogData(filename, sf, channels, tstart, tend)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
AnalogWaveforms        = zeros(AnalogSampleReadCount, length(channels));
% Get data
j=1;
for i = 1:length(channels)
    ...
    if ~isempty(thisID)
        ...
        [~, AnalogSampleCounts(j), AnalogWaveforms(:,j)] = ...
