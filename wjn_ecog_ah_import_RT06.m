...
dlb=wjn_eeg_burst_analysis(Dcont.fullfile,[10 35],[],[sSTN sStrip],[],'brown');
...
smspac = squeeze(nanmean(Dp(ci(sSTN,Dp.chanlabels),:,:,1),1));
smlpac = squeeze(nanmean(Dp(ci(sSTN,Dp.chanlabels),:,:,2),1));

%%
ich = ci('Strip',Dp.chanlabels);
