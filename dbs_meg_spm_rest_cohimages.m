...
for r = 1:numel(stnchans)
    ...
    for f = 1%:numel(ranges)
        ...
        %load(fullfile(dbsroot, 'SPM', 'cohimage_ttest_job.mat'));
        ...
        for shuffle = 0:10 % Number of shufflings
            ...
            if ~shuffle
                ...
                spm_imcalc_ui(fullfile(cD.path, 'dummy', 'type_Undefined', 'trial0001.img'),...
            ...
            spm_smooth(fullfile(cD.path, 'dummy', 'type_Undefined', 'trial0001.img'),...
