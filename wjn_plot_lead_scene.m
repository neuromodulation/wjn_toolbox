function wjn_plot_lead_scene
% - Lead-DBS Job created on 19-Sep-2017 09:35:57 -
% --------------------------------------

addpath(genpath('E:\Dropbox (Personal)\matlab\lead'));
addpath('E:\Dropbox (Personal)\matlab\spm12');
...
options.earoot = 'E:\Dropbox (Personal)\matlab\lead\';
options.dicomimp = 0;
options.assignnii = 0;
...
options.prefs.lc.datadir = 'E:\Dropbox (Personal)\matlab\lead\connectomes\';
